...
import com.cold.storage.inbound.data.processor.processor.Processor;
import com.optum.eligibility.eoe.prevalidation.process.util.TestUtils;
...
public class ProcessorTest {
    ...
    public ProcessorTest(Processor processoor) {
        this.processoor = processoor;
    }
